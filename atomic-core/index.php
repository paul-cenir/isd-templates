    ...
    <div class="atoms-main">
        ...
        <?php if (!empty($_GET['cat']) || !empty($_GET['search'])) { ?>
            <?php if (!empty($_GET['cat'])) { ?>
                <div id="modules" class="atomic-h1 comp-header-container"><span><?php echo $_GET['cat']; ?></span> <a
            ...
            foreach ($compSelect as $component) {
                ...
                <div id="<?php echo $component['component'] ?>"
                   class="content-editable compTitle">
                    <div>
                        <span class="comp-text-container"><?php echo $component['component'] ?></span>
                    </div>
                    <div class="comp-view-edit-container">
